...
def view_setup_toolkit(gui):
    ...
    tool_box_column= [
        [sg.Button('Start Carla Sim', size=(10, 2)), sg.Button('Kill Carla Sim', size=(10, 2))],
        [sg.Button('Start Carla-Autoware', size=(10, 2)), sg.Button('Kill Carla-Autoware', size=(10, 2))],
        [sg.Button('Start Carla-Autoware Patch', size=(26, 2))],
        [sg.Button('Start Roslaunch', size=(10, 2)), sg.Button('Kill Roslaunch', size=(10, 2))],
        [sg.Text("Scenarios")],
    ...
    main_column = [
        [sg.Text("Choose a scenario from list on left:")],
        [sg.Text(size=(40, 1), key="-TEXT-")],
        [sg.Image(key="-FILES-")],
    ]

    scenarios = [
        [sg.Button('Start Follow Vehicle', size=(10, 2)), sg.Button('Kill Follow Vehicle', size=(10, 2))],
        [sg.Button('Start Pedestrian', size=(10, 2)), sg.Button('Kill Pedestrian', size=(10, 2))],
    ]

    tabs = [[sg.TabGroup([[  sg.Tab('Tool-Box', tool_box_column),
                            sg.Tab('Scenarios', scenarios)
